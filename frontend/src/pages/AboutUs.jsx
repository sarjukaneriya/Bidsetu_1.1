          ...
          <div className="flex flex-col gap-4 lg:min-w-[50%] lg:w-1/2">
            <div className="mb-4">
              ...
              <h2 className="mt-2 text-4xl font-medium">
                Largest Marketplace To Buy And Sell 
              </h2>
            </div>
            <div className="text-body-text-color">
              <p className="mb-2">
  Welcome to our Reverse Auction Platform – where businesses and organizations post their needs, and suppliers from around the world compete to offer the best value. It is a powerful way to drive down procurement costs while ensuring quality and transparency.
</p>
<p className="mb-2">
  Whether you are sourcing bulk raw materials, logistics services, or customized software solutions – our platform helps you connect with verified suppliers who bid competitively to win your project, saving you time and money.
</p>
<p>
  Are you a supplier? Join our platform to bid on high-value projects, showcase your capabilities, and expand your reach to a global clientele actively looking for cost-effective and reliable solutions.
</p>
          ...
          <div className="grid grid-cols-1 m-auto gap-5   w-full  md:grid-cols-2 lg:grid-cols-4">
            <div className="flex flex-col text-white gap-4 justify-start p-8 rounded-2xl bg-theme-bg ">
              ...
              <p className="text-body-text-color">
                Register for a free account and unlock the power to sell & Buy
                anything, anytime.
              </p>
            </div>
            <div className="flex flex-col text-white gap-4 justify-start p-8 rounded-2xl bg-theme-bg ">
              ...
              <p className="text-body-text-color">
                Create a compelling listing that Buy item and
                Get Best Deals.
              </p>
            </div>
            <div className="flex flex-col text-white gap-4 justify-start p-8 rounded-2xl bg-theme-bg ">
            ...
            <div className="flex flex-col text-white gap-4 justify-start p-8 rounded-2xl bg-theme-bg ">
              ...
              <p className="text-body-text-color">
                Bid on Requirements and watch the bids come in, turning your
